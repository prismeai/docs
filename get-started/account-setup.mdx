  ...
  <Tab title="Enterprise Users">
    <Steps>
      <Step title="SSO Authentication">
        ...
        <Frame>
          <img src="/images/get-started-sso-login.png" alt="Prisme.ai sign-in screen with SSO options" />
        </Frame>
      ...
      <Step title="Interface Customization">
        ...
        <Frame>
          <img src="/images/get-started-settings-language.png" alt="Settings page with the Language tab selected" />
        </Frame>
      ...
      <Step title="LLM Model Access">
        ...
        <Frame>
          <img src="/images/get-started-chat-model-selection.png" alt="Chat conversation with the model selector open" />
        </Frame>
  ...
  <Tab title="Standard Users">
    <Steps>
      <Step title="Account Creation">
        ...
        <Frame>
          <img src="/images/get-started-account-creation.png" alt="Prisme.ai account creation form" />
        </Frame>
      ...
      <Step title="Set Your Preferences">
        ...
        <Frame>
          <img src="/images/get-started-settings-language.png" alt="Settings page with language preferences" />
        </Frame>
      ...
      <Step title="LLM Model Access">
        ...
        <Frame>
          <img src="/images/get-started-chat-model-selection.png" alt="Chat conversation with available LLM models open" />
        </Frame>
...
<Tabs>
  ...
  <Tab title="No-code Builder">
    As a power user who builds without code:
    - Access to the create products: Agent Creator, Knowledges, Collections
    - Build agents, assistants, and simple apps, then share them
    - Set up instructions, starters, and capabilities
  </Tab>
...
<CardGroup cols={3}>
  ...
  <Card title="Explore use cases" icon="lightbulb" href="/resources/use-cases/overview">
    Agents, agentic workflows, and full-stack portals
  </Card>
</CardGroup>
