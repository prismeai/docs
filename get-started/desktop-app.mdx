...
<CardGroup cols={2}>
  <Card title="macOS" icon="apple" href="https://github.com/prismeai/desktop/releases/latest">
    Apple silicon + Intel (`.dmg`). Requires macOS 10.15 or later.
  </Card>
  <Card title="Windows" icon="windows" href="https://github.com/prismeai/desktop/releases/latest">
    64-bit (`.exe`). Requires Windows 10 or later.
  </Card>
</CardGroup>

Every build is listed on the [Releases page](https://github.com/prismeai/desktop/releases/latest).
