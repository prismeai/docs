...
- **Connectors:** All Google app + MCP connectors (Drive, Docs, Sheets, Calendar, Mail, Search) received security updates.
...
<Warning>
**Breaking change — Google connectors renamed**

All Google app + MCP connectors changed their `AppSlug` to PascalCase to match the connector naming guidelines: Drive, Docs, Sheets, Calendar, Mail, Search.

Existing automations or imports referencing the old slugs must be updated.
</Warning>
