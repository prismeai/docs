...
<Update label="Latest Release" description="Releasing version v26.02.181700">
...
- **Readiness API:** New `/v2/readiness` configuration check that verifies all database connections from all services (core + apps), HTTP connections between internal services, and returns detailed errors
