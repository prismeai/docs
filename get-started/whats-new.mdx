...
- **Auth:** OIDC profile claims are now read from the `userinfo` endpoint. See [Authentication → Configuring OIDC Authentication](/self-hosting/entreprise/authentication#configuring-oidc-authentication).
