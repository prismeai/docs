...
- **Automations:** Custom headers starting with `x-` can now be sent to automations exposed as webhooks, and used by them. See [Automations → Triggers](/products/ai-builder/automations#triggers).
