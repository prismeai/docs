...
<Update label="v26.03.021352" description="Releasing version v26.03.021352">
  **Features & Improvements :**
  ...
  - **[Native workspaces](https://docs.prisme.ai/self-hosting/install-products#3-products-initialization):** AI Knowledge, AI Governance, and other native workspaces are now bundled in the `prismeai-workspaces` image and can be imported from the Platform workspace UI (super admins only).
