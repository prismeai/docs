...
<Steps>
  ...
  <Step title="Create your first simple agent">
    Follow our [Creating Your First Agent tutorial](../tutorials/first-agent) to build a basic agent. This hands-on experience will help you understand the core concepts of agent creation.
  </Step>
</Steps>
...
<AccordionGroup>
  ...
  <Accordion title="Connect to external data sources">
    ...
    [Detailed Guide →](../connect-data-sources/overview)
  </Accordion>
</AccordionGroup>
