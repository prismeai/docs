...
description: "Log in and build your first agent or app on Prisme.ai."
---
...
<Steps>
  <Step title="Log in to your Prisme.ai account">
    ...
    <Frame>
      <img src="/images/get-started-login.png" alt="Prisme.ai sign-in screen" />
    </Frame>
  </Step>
  ...
  <Step title="Explore the home screen">
    ...
    <Frame>
      <img src="/images/get-started-dashboard.png" alt="Prisme.ai home screen with product navigation" />
    </Frame>
  ...
  <Step title="Try Chat">
    ...
    <Frame>
      <img src="/images/get-started-chat-conversation.png" alt="Chat conversation interface with an assistant ready for a message" />
    </Frame>
  ...
  <Step title="Build your first thing">
    An agent is just one option. Business users can build a no-code agent in [Agent Creator](/products/agent-factory/creating-agents); developers can build a full application, a workflow, or even a custom CRM in [Builder](/products/ai-builder/overview). Browse [use cases](/resources/use-cases/overview) to see the three shapes: agents, agentic workflows, and full-stack portals.
  </Step>
</Steps>
...
<Tabs>
  ...
  <Tab title="Developer">
    Agents are one feature, not the whole platform. As a developer you build **full applications** on the same stack:
    - Build web apps, agentic workflows, and endpoints in [Builder](../products/ai-builder/overview), from VS Code over MCP
    - Ship a real product: a portal, a custom CRM, a compliance system. See [use cases](/resources/use-cases/overview)
    - Connect your systems with connectors, API, and MCP, and version everything in Git
