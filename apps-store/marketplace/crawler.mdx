...
<Frame>
  <img src="/images/crawler.png" alt="Crawler" />
</Frame>
...
The Crawler app provides extensive configuration options to tailor its behavior to your specific needs:
  ...
  <Accordion title="URL Configuration">
    ...
    ```yaml
      ...
      config:
        ...
        websites_config:
          www.issy.com:
            blacklisted_patterns:
              - /recherche.*
          www.issy-tourisme-international.com:
            blacklisted_patterns:
              - /recherche.*
        ...
        crawlerId: issy.com
        webhook: https://api.studio.prisme.ai/v2/workspaces/BmNDw-1/webhooks/Crawler.webhook
        uploads_config:
          url: "URL_AUTO_GENERATED"
          api_key: "API_KEY_AUTO_GENERATED"

    ```
    
    This configuration starts crawling from the documentation root, follows links up to 3 levels deep, includes guides and API documentation, but excludes blog posts and changelogs.
  </Accordion>
  
  <Accordion title="Content Selection">
    Define which content elements to extract:
    ...
    This configuration extracts content from `article` elements and elements with the `.documentation-content` class, ignores navigation, footers, and comments, and identifies headings for structural understanding.
  </Accordion>
  
  <Accordion title="Processing Options">
    Configure how content is ignored:
    ...
    crawler:
        websites_config:
          www.mywebsite.fr:
            ...
            blacklisted_patterns:
              - .*/detail/article/.*
              - .*/les-dossiers-du-departement/.*
              - .*/les-actualites-de-la-presidente/.*
              - .*/retour-sur/.*
