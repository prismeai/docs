...
<CardGroup cols={3}>
  <Card title="Agent builder" icon="robot">
    You build agents in **Agent Creator** and want them to read and act on Confluence. → *Agent builder* tab.
  </Card>
