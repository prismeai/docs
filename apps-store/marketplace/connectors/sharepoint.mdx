...
<Note>
  For AI Knowledge document sync with per-user access control, see the dedicated [SharePoint Connector for AI Knowledge](/products/ai-knowledge/sharepoint-connector) documentation.
</Note>
...
<Tabs>
  ...
  <Tab title="Usage as MCP">
    ...
    See [SharePoint Connector for AI Knowledge](/products/ai-knowledge/sharepoint-connector) for detailed PBAV documentation.
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  ...
  <Card title="AI Knowledge SharePoint Connector" icon="database" href="/products/ai-knowledge/sharepoint-connector">
