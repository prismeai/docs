...
| **Default Goggles** | _(empty)_ | **Primary place to configure a Brave Goggle.** Paste a raw Goggle definition or a hosted URL; it is applied to every call from this workspace. Leave empty only if you intentionally want unfiltered Brave Search. |
