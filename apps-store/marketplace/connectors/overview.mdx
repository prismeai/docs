...
<CardGroup cols={2}>
  ...
  <Card title="MCP Mode" icon="robot">
    Connect the MCP endpoint to Agent Creator agents. They discover and use tools automatically.
...
Most App + MCP connectors share the same install, authentication, and capability procedures. These three pages document them once; each connector page covers only what is specific to its provider.

<CardGroup cols={3}>
  <Card title="Install in your workspace" icon="puzzle-piece" href="/apps-store/marketplace/connectors/install-in-workspace">
    Workspace builder: install the app, enter credentials in the configuration app, allowlist agents, verify, then rotate or uninstall.
  </Card>
  <Card title="Central OAuth client" icon="key" href="/apps-store/marketplace/connectors/central-oauth">
    Platform admin: register one platform-wide OAuth client, and understand what it changes about agent authorization.
  </Card>
  <Card title="Declare a capability" icon="plug" href="/apps-store/marketplace/connectors/declare-capability">
    Wire the connector to an agent, publish it to the organization Capabilities catalog, or declare it by hand in AI Governance.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Azure OCR" icon="/images/connectors/azure-ocr.png" href="/apps-store/marketplace/connectors/azure-ocr">
    Extract text and structured data from images and documents with Azure Computer Vision and Document Intelligence, from Agent Creator agents (MCP) or Builder workflows.
  </Card>
  ...
  <Card title="Confluence" icon="/images/connectors/confluence.svg" href="/apps-store/marketplace/connectors/confluence">
  ...
  <Card title="Google Chat" icon="/images/connectors/google-chat.png" href="/apps-store/marketplace/connectors/google-chat">
    Bridge a Google Chat bot to a Prisme.ai Agent Creator agent through an HTTPS webhook. Per-thread context, async acknowledgement and service-account-signed replies.
  </Card>
  ...
  <Card title="Jira" icon="/images/connectors/jira-next.png" href="/apps-store/marketplace/connectors/jira">
  ...
  <Card title="Jira (legacy)" icon="/images/connectors/jira.svg" href="/apps-store/marketplace/connectors/jira-legacy">
  ...
  <Card title="Knowledges" icon="/images/connectors/knowledges.png" href="/apps-store/marketplace/connectors/knowledges">
    Manage Prisme.ai knowledge bases, their documents and web crawl sources, and run semantic search. Three entity tools, no credential to paste.
  </Card>
  <Card title="Microsoft Teams" icon="/images/connectors/microsoft-teams.png" href="/apps-store/marketplace/connectors/microsoft-teams">
    Teams, channels, chats and online meetings with their transcripts via Microsoft Graph, behind four MCP entity tools, plus an inbound Teams bot.
  </Card>
  ...
  <Card title="OneNote" icon="/images/connectors/onenote.svg" href="/apps-store/marketplace/connectors/onenote">
    OneNote notebooks, sections and page text via Microsoft Graph, behind five MCP entity tools, with delegated per-user Microsoft Entra OAuth.
  </Card>
  ...
  <Card title="Outlook (legacy)" icon="/images/connectors/outlook.png" href="/apps-store/marketplace/connectors/outlook-legacy">
  ...
  <Card title="Power BI" icon="/images/connectors/powerbi.png" href="/apps-store/marketplace/connectors/powerbi">
  ...
  <Card title="SharePoint" icon="/images/connectors/sharepoint.svg" href="/apps-store/marketplace/connectors/sharepoint">
    SharePoint sites, document libraries, files, lists and permissions via Microsoft Graph, behind ten MCP entity tools, with per-user Microsoft Entra OAuth (tenant-context App+MCP).
  </Card>
  <Card title="SharePoint (legacy)" icon="/images/connectors/sharepoint.svg" href="/apps-store/marketplace/connectors/sharepoint-legacy">
    Legacy SharePoint connector (Microsoft Graph, application or delegated-OAuth). Superseded by the SharePoint connector.
  </Card>
  <Card title="Snowflake" icon="/images/connectors/snowflake.png" href="/apps-store/marketplace/connectors/snowflake">
    Run SQL and manage asynchronous results, databases, schemas and virtual warehouses through five MCP entity tools.
  </Card>
  ...
  <Card title="Storage (deprecated)" icon="database" href="/apps-store/marketplace/connectors/storage-client">
    Deprecated: use Knowledges instead. Still the only connector exposing the administrative surface: per-knowledge-base API keys, RBAC bindings, skills and diagnostics.
  </Card>
  ...
  <Card title="WebDAV" icon="/images/connectors/webdav.jpg" href="/apps-store/marketplace/connectors/webdav">
    Browse, read and write files on any WebDAV server (Nextcloud, ownCloud, generic HTTPS WebDAV). 10 file and directory operations with Basic or Bearer auth. Also available as an AI Knowledge connector.
  </Card>
