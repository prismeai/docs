...
<CardGroup cols={2}>
  ...
  <Card title="Teams" icon="/images/connectors/teams.png" href="/apps-store/marketplace/connectors/teams">
    Microsoft Teams meetings, transcripts and attendance via Microsoft Graph, plus a Bot Framework channel for agent conversations, in application or delegated-OAuth mode.
  </Card>
