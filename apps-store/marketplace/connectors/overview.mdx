...
<CardGroup cols={2}>
  ...
  <Card title="Jira" icon="/images/connectors/jira-next.png" href="/apps-store/marketplace/connectors/jira">
    Search, create and manage Jira Cloud or Data Center through seven MCP entity tools, with per-user OAuth or Data Center PAT authentication.
  </Card>
  ...
  <Card title="Storage (deprecated)" icon="database" href="/apps-store/marketplace/connectors/storage-client">
    Deprecated — use Knowledges instead. Still the only connector exposing the administrative surface: per-store API keys, RBAC bindings, skills and diagnostics.
  </Card>
