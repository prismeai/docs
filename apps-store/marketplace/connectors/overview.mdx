...
<CardGroup cols={2}>
  ...
  <Card title="HubSpot" icon="address-book" href="/apps-store/marketplace/connectors/hubspot">
    Read and write HubSpot CRM, engagements and Marketing data: contacts, companies, deals, tickets, lists, forms, workflows and File Manager.
  </Card>
