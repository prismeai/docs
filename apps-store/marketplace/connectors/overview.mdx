...
<CardGroup cols={2}>
  ...
  <Card title="Figma" icon="bezier-curve" href="/apps-store/marketplace/connectors/figma">
  ...
  <Card title="Salesforce" icon="cloud" href="/apps-store/marketplace/connectors/salesforce">
