...
<Card title="Connector architecture and security" icon="diagram-project" href="/apps-store/marketplace/connectors/architecture">
  Review the current App + MCP reference architecture, including tenant and optional global MCP endpoints and security controls.
</Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Google Calendar" icon="/images/connectors/google-calendar.svg" href="/apps-store/marketplace/connectors/google-calendar">
    Read and write Google Calendar with per-user OAuth. 32 operations across events, calendars, calendar list, ACL sharing, settings, colors and free/busy.
  </Card>
  ...
  <Card title="Google Docs" icon="/images/connectors/google-docs.svg" href="/apps-store/marketplace/connectors/google-docs">
    Create, read and edit Google Docs with per-user OAuth. 2 base operations + ~30 atomic editing tools (text, paragraphs, tables, headers, images, named ranges).
  </Card>
  <Card title="Google Drive" icon="/images/connectors/google-drive.svg" href="/apps-store/marketplace/connectors/google-drive">
    Browse, organize and collaborate on Google Drive with per-user OAuth. 27 operations covering files, permissions, comments, replies and revisions.
  </Card>
  <Card title="Google Mail" icon="/images/connectors/google-mail.png" href="/apps-store/marketplace/connectors/google-mail">
    Read, send and manage Gmail mailboxes with per-user OAuth. 13 entity-grouped MCP tools covering messages, threads, drafts, labels, filters, settings, identities and delegates.
  </Card>
  <Card title="Google Sheets" icon="/images/connectors/google-sheets.svg" href="/apps-store/marketplace/connectors/google-sheets">
    Read and write Google Sheets with per-user OAuth. 45 operations across spreadsheets, values, sheets, dimensions, cells, find/replace, charts, named & protected ranges.
  </Card>
