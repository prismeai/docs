---
title: 'Jira'
description: 'Search, create and manage Atlassian Jira Cloud and Data Center issues, projects, users, metadata and agile boards from Agent Creator agents and Builder workflows, with per-user Atlassian OAuth'
---
...
<CardGroup cols={3}>
  <Card title="Agent builder" icon="robot">
    You build agents in **Agent Creator** and want them to read and act on Jira. → *Agent builder* tab.
  </Card>
