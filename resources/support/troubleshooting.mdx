...
<Steps>
  <Step title="Check Document Status">
    Verify the current status of your document in Knowledges:
...
<Steps>
  ...
  <Step title="Fix Relevance Issues">
    ...
    **Advanced Solution**: Implement custom reranking logic by using Builder to create a post-processing step that sorts retrieved chunks by relevance.
  </Step>
