...
<Frame>
  <img src="/images/troubleshooting.png" alt="Troubleshooting Guide" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Community Forum" icon="users" href="https://community.prisme.ai">
    Connect with other users and share solutions
  </Card>
  <Card title="Common Issues" icon="exclamation-circle" href="/resources/support/common-issues">
