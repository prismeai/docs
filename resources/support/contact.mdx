...
<Frame>
  ![Troubleshooting Guide](/images/hero-light.png)
</Frame>
...
```
Subject: Error when uploading documents to Knowledges project

Description:
When uploading PDF documents larger than 10MB to our "Customer Support" Knowledges project, the upload appears to complete successfully, but the documents remain in "Processing" status indefinitely.
...
2. Navigate to Knowledges > Projects > Customer Support
