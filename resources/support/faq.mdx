...
<AccordionGroup>
  <Accordion title="What is Prisme.ai?">
    Prisme.ai is an enterprise-grade AI platform, the unified foundation for the AI Information System of tomorrow, that helps organizations build, deploy, and manage AI solutions instead of stitching together disconnected silos. Every product (agents, knowledge bases, and custom applications) is a facet of the same governed, traceable foundation, with two doors into it: a business no-code experience and a technical full-code experience.
