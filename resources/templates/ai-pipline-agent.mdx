...
<Frame>
  <img src="/images/ai-pipeline-agent.png" alt="AI Pipeline Workflow" />
</Frame>
...
<Steps>
  <Step title="Download the Template">
    Access the [Prisme.ai Templates Repository](https://github.com/prisme-ai/templates/ai-pipeline) and download the ZIP file
  </Step>
...
- Explore how to build custom tools in the [AI Builder documentation](/products/ai-builder/tools-integration)
