...
<Frame>
  <img src="/images/sharepoint-confluence-agent.png" alt="SharePoint and Confluence Integration" />
</Frame>
...
<Steps>
  <Step title="Download the Template">
    Access the [Prisme.ai Templates Repository](https://github.com/prisme-ai/templates/sharepoint-confluence-agent) and download the ZIP file
  </Step>
