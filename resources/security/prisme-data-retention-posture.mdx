...
Prisme.ai's [LLM Gateway](/llm-gateway) can route inference to several model providers and to self-hosted models. Because data-retention behaviour depends on the **route taken**, not on the platform alone, Prisme.ai classifies routes into two tiers:
