...
<AccordionGroup>
  ...
  <Accordion title="Required OIDC Configuration">
    ...
    - Userinfo endpoint (*optional*, only needed when your IdP omits the profile
      claims from the `id_token`, see [Authentication](/self-hosting/entreprise/authentication))
  </Accordion>
</AccordionGroup>
