---
title: 'Compliance'
description: 'Understanding Prisme.ai's security compliance, certifications, and regulatory adherence'
---

<Frame>
  <img src="/images/compliance.png" alt="Prisme.ai Compliance" />
</Frame>
...
Prisme.ai has achieved and maintains the following security certifications:

<CardGroup cols={2}>
  <Card title="ISO 27001" icon="certificate">
    Information Security Management System certification
  </Card>
  <Card title="Cloud Security Alliance" icon="cloud">
...
<CardGroup cols={2}>
  ...
  <Card title="Private Cloud" icon="cloud-upload-alt">
    Deploy in your own cloud environment (AWS, Azure, GCP)
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Security Blog" icon="blog" href="https://prisme.ai/blog/category/security">
    Latest updates on our security and compliance initiatives
  </Card>
  <Card title="Trust Center" icon="lock" href="https://trust.prisme.ai">
