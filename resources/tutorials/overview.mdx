...
<CardGroup cols={2}>
  ...
  <Card title="Manage Agent Conversations via API" icon="messages" href="/resources/tutorials/manage-agent-conversations-via-api">
    List, load, and continue a user's agent conversations.
  </Card>
