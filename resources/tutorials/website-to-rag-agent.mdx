...
<iframe src="https://www.loom.com/embed/39a5c713c6f4436ab30de3ad6fde4cb8?sid=e0d47a18-de28-4768-8329-018228539d2d" frameBorder="0" allowFullScreen />
...
<Steps>
  ...
  <Step title="Duplicate the Template">
    ...
    <Frame>
      ![Duplicating the Website to RAG Template](/images/duplicate-website-rag-template.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="View Installed Apps">
    ...
    <Frame>
      ![Installed Applications](/images/installed-apps.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Enter Your Website URL">
    ...
    <Frame>
      ![Configuring the Website Crawler](/images/crawler-configuration.png)
    </Frame>
  </Step>
  <Step title="Configure Crawling Parameters">
    ...
    - \*_Authentication_: Set up authentication if required.
  ...
  <Step title="Monitor Crawling Progress">
    ...
    <Frame>
      ![Monitoring Crawling Progress](/images/crawling-progress.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Ask Questions About Your Website">
    ...
    <Frame>
      ![Testing the Chat Interface](/images/chat-interface-testing.png)
    </Frame>
  </Step>
  <Step title="Explore Available Documents">
    ...
    <Frame>
      ![AI Knowledge Hub](/images/ai-knowledge-hub.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Customize Appearance">
    ...
    <Frame>
      ![Customizing the Chat Widget](/images/widget-customization.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Get the Embed Code">
    ...
    <Frame>
      ![Getting the Embed Code](/images/embed-code.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Add Python Custom Code">
    ...
    <Frame>
      ![Advanced RAG Customization](/images/advanced-rag-customization.png)
    </Frame>
  </Step>
