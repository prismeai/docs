...
<Frame>
  <img src="/images/ai-builder-custom-apps.png" alt="Building Custom Apps with AI Builder" />
</Frame>
...
<Steps>
  ...
  <Step title="Define the Automation Logic">
    ...
    <Frame>
      <img src="/images/automation-configuration.png" alt="Automation Configuration" />
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Define Configuration Fields">
    ...
    <Frame>
      <img src="/images/config-workspace.png" alt="Workspace Configuration" />
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Make Documentation Public">
    ...
    <Frame>
      <img src="/images/public-app-setting.png" alt="Public App Setting" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Publish to App Store">
    ...
    <Frame>
      <img src="/images/publish-app.png" alt="Publish App" />
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Configure App Settings">
    ...
    <Frame>
      <img src="/images/app-with-config.png" alt="App with Configuration" />
    </Frame>
  </Step>
