---
title: 'RAG Agents'
description: 'Learn how to create AI agents that leverage your organization's knowledge through Retrieval Augmented Generation'
---
...
<Frame>
  <img src="/images/rag-agent-diagram.png" alt="RAG Agent Architecture" />
</Frame>
...
<Steps>
  ...
  <Step title="Query Processing">
    ...
    <Frame>
      <img src="/images/query-processing.png" alt="Query Processing" />
    </Frame>
  ...
  <Step title="Retrieval">
    ...
    <Frame>
      <img src="/images/retrieval-process.png" alt="Retrieval Process" />
    </Frame>
  ...
  <Step title="Context Assembly">
    ...
    <Frame>
      <img src="/images/context-assembly.png" alt="Context Assembly" />
    </Frame>
  ...
  <Step title="Response Generation">
    ...
    <Frame>
      <img src="/images/response-generation-rag.png" alt="Response Generation" />
    </Frame>
...
<Tabs>
  <Tab title="Technical Support">
    ...
    **Key Features**:
    ...
    <Frame>
      <img src="/images/technical-support-rag.png" alt="Technical Support RAG Agent" />
    </Frame>
  </Tab>
  ...
  <Tab title="Policy Guidance">
    ...
    **Key Features**:
    ...
    <Frame>
      <img src="/images/policy-guidance-rag.png" alt="Policy Guidance RAG Agent" />
    </Frame>
  </Tab>
  ...
  <Tab title="Research Assistant">
    ...
    **Key Features**:
    ...
    <Frame>
      <img src="/images/research-assistant-rag.png" alt="Research Assistant RAG Agent" />
    </Frame>
  </Tab>
  ...
  <Tab title="Knowledge Management">
    ...
    **Key Features**:
    ...
    <Frame>
      <img src="/images/knowledge-management-rag.png" alt="Knowledge Management RAG Agent" />
    </Frame>
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="AI Knowledge">
    ...
    <Frame>
      <img src="/images/ai-knowledge-interface.png" alt="AI Knowledge Interface" />
    </Frame>
  ...
  <Tab title="AI Builder">
    ...
    <Frame>
      <img src="/images/ai-builder-rag.png" alt="AI Builder RAG Implementation" />
    </Frame>
