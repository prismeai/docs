...
<Frame>
  <img src="/images/no-code-agents-overview.png" alt="No-Code Agents Overview" />
</Frame>
...
<Tabs>
  <Tab title="Simple Prompting Agents">
    ...
    <Frame>
      <img src="/images/simple-prompting-no-code.png" alt="Simple Prompting No-Code" />
    </Frame>
  ...
  <Tab title="RAG Agents">
    ...
    <Frame>
      <img src="/images/rag-no-code.png" alt="RAG No-Code" />
    </Frame>
  ...
  <Tab title="RAG with Built-in Tools">
    ...
    <Frame>
      <img src="/images/rag-tools-no-code.png" alt="RAG with Tools No-Code" />
    </Frame>
...
<Steps>
  ...
  <Step title="Select Agent Type">
    ...
    <Frame>
      <img src="/images/agent-type-selection.png" alt="Agent Type Selection" />
    </Frame>
  ...
  <Step title="Test and Refine">
    ...
    <Frame>
      <img src="/images/agent-testing.png" alt="Agent Testing" />
    </Frame>
  ...
  <Step title="Deploy and Monitor">
    ...
    <Frame>
      <img src="/images/agent-deployment.png" alt="Agent Deployment" />
    </Frame>
...
<Frame>
  <img src="/images/ai-store-creation.png" alt="AI Store Creation Interface" />
</Frame>
...
<Steps>
  <Step title="Create New Agent">
    ...
    <Frame>
      <img src="/images/create-new-agent.png" alt="Create New Agent" />
    </Frame>
  ...
  <Step title="Define Basic Information">
    ...
    <Frame>
      <img src="/images/define-agent-info.png" alt="Define Agent Information" />
    </Frame>
  ...
  <Step title="Configure Capabilities">
    ...
    <Frame>
      <img src="/images/configure-capabilities.png" alt="Configure Capabilities" />
    </Frame>
  ...
  <Step title="Set System Instructions">
    ...
    <Frame>
      <img src="/images/set-system-instructions.png" alt="Set System Instructions" />
    </Frame>
  ...
  <Step title="Test and Preview">
    ...
    <Frame>
      <img src="/images/test-preview-agent.png" alt="Test and Preview Agent" />
    </Frame>
  ...
  <Step title="Publish and Share">
    ...
    <Frame>
      <img src="/images/publish-share-agent.png" alt="Publish and Share Agent" />
    </Frame>
