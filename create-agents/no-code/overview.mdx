...
No-code is the business door into the same unified foundation your technical teams build on. Agents created here inherit the platform's governance and traceability by design, so business experts can move fast without stepping outside enterprise controls.
...
<Tabs>
  ...
  <Tab title="RAG Agents">
    ...
    **Best For:**
    ...
    [Learn more about RAG Agents →](/products/agent-factory/creating-agents)
  </Tab>
...
## Creating Agents with Agent Creator

Prisme.ai's Agent Creator provides a user-friendly interface for creating no-code agents:
...
<CardGroup cols={2}>
  ...
  <Card title="RAG Agent" icon="book-open" href="/products/agent-factory/creating-agents">
  ...
  <Card title="Agent Creator Guide" icon="store" href="/products/agent-factory/creating-agents">
    Learn more about the Agent Creator platform
  </Card>
</CardGroup>