...
<Frame>
  <img src="/images/tool-using-agents-overview.png" alt="Tool-Using Agents Overview" />
</Frame>
...
<Frame>
  <img src="/images/tool-agent-architecture.png" alt="Tool Agent Architecture" />
</Frame>
...
<Steps>
  <Step title="Request Understanding">
    ...
    <Frame>
      <img src="/images/request-understanding.png" alt="Request Understanding" />
    </Frame>
  ...
  <Step title="Parameter Preparation">
    ...
    <Frame>
      <img src="/images/parameter-preparation.png" alt="Parameter Preparation" />
    </Frame>
  ...
  <Step title="Result Interpretation">
    ...
    <Frame>
      <img src="/images/result-interpretation.png" alt="Result Interpretation" />
    </Frame>
  ...
  <Step title="Response Generation">
    ...
    <Frame>
      <img src="/images/tool-response-generation.png" alt="Response Generation" />
    </Frame>
...
<Tabs>
  <Tab title="No-Code in AI Knowledge">
    ...
    <Frame>
      <img src="/images/ai-knowledge-tools.png" alt="AI Knowledge Tools Configuration" />
    </Frame>
  ...
  <Tab title="Advanced in AI Builder">
    ...
    <Frame>
      <img src="/images/ai-builder-tools.png" alt="AI Builder Tools Integration" />
    </Frame>
...
<Frame>
  <img src="/images/web-browsing-tool-example.png" alt="Web Browsing Tool Example" />
</Frame>
...
<Tabs>
  <Tab title="IT Support">
    **Purpose**: Automate IT service desk functions through system integration
    ...
    <Frame>
      <img src="/images/it-support-tool-agent.png" alt="IT Support Tool Agent" />
    </Frame>
  ...
  <Tab title="Sales Assistant">
    **Purpose**: Support sales teams with data-driven insights and process automation
    ...
    <Frame>
      <img src="/images/sales-assistant-tool-agent.png" alt="Sales Assistant Tool Agent" />
    </Frame>
  ...
  <Tab title="Operations Monitor">
    **Purpose**: Monitor and manage operational systems with automated interventions
    ...
    <Frame>
      <img src="/images/operations-monitor-tool-agent.png" alt="Operations Monitor Tool Agent" />
    </Frame>
  ...
  <Tab title="Research Assistant">
    **Purpose**: Support research and analysis with data gathering and processing
    ...
    <Frame>
      <img src="/images/research-assistant-tool-agent.png" alt="Research Assistant Tool Agent" />
    </Frame>
