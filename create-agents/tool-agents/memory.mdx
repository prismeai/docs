...
Memory draws on the same unified foundation as the rest of the platform: its event-driven, natively traceable architecture lets agents persist and recall context while keeping every interaction governed and auditable.
...
## Memory Management in Knowledges

For Knowledges agents, configure memory effectively through these approaches:

<Steps>
  <Step title="Configure Conversation History">
    Set appropriate history retention in Knowledges.
...
<CardGroup cols="2">
  <Card title="Execution & Activity" icon="bolt" href="/products/agent-factory/analytics">
  ...
  <Card title="Advanced RAG" icon="wand-sparkles" href="/products/ai-knowledge/advanced-rag">
