...
<Frame>
  <img src="/images/memory-management-overview.png" alt="Memory Management Overview" />
</Frame>
...
<Tabs>
  <Tab title="LLM Context Window">
    ...
    <Frame>
      <img src="/images/llm-context-memory.png" alt="LLM Context Memory" />
    </Frame>
  ...
  <Tab title="Conversation State">
    ...
    <Frame>
      <img src="/images/conversation-state.png" alt="Conversation State" />
    </Frame>
  ...
  <Tab title="Database Persistence">
    ...
    <Frame>
      <img src="/images/database-persistence.png" alt="Database Persistence" />
    </Frame>
  ...
  <Tab title="Event History">
    ...
    <Frame>
      <img src="/images/event-history.png" alt="Event History" />
    </Frame>
...
<Steps>
  <Step title="Configure Memory Storage">
    ...
    <Frame>
      <img src="/images/memory-storage-config.png" alt="Memory Storage Configuration" />
    </Frame>
  ...
  <Step title="Create Memory Management Functions">
    ...
    <Frame>
      <img src="/images/memory-functions.png" alt="Memory Functions" />
    </Frame>
  ...
  <Step title="Implement Memory Updates">
    ...
    <Frame>
      <img src="/images/memory-updates.png" alt="Memory Updates" />
    </Frame>
  ...
  <Step title="Integrate Memory with LLM Context">
    ...
    <Frame>
      <img src="/images/memory-llm-integration.png" alt="Memory LLM Integration" />
    </Frame>
  ...
  <Step title="Implement Memory Cleanup">
    ...
    <Frame>
      <img src="/images/memory-cleanup.png" alt="Memory Cleanup" />
    </Frame>
...
<Steps>
  <Step title="Create User Profile Structure">
    ...
    <Frame>
      <img src="/images/user-profile-schema.png" alt="User Profile Schema" />
    </Frame>
  ...
  <Step title="Implement Profile Management">
    ...
    <Frame>
      <img src="/images/profile-management.png" alt="Profile Management" />
    </Frame>
  ...
  <Step title="Integrate Profiles with Agent Behavior">
    ...
    <Frame>
      <img src="/images/profile-integration.png" alt="Profile Integration" />
    </Frame>
  ...
  <Step title="Update Profiles Based on Interactions">
    ...
    <Frame>
      <img src="/images/profile-updates.png" alt="Profile Updates" />
    </Frame>
...
<Steps>
  <Step title="Configure Conversation History">
    ...
    <Frame>
      <img src="/images/aik-history-config.png" alt="AI Knowledge History Configuration" />
    </Frame>
  ...
  <Step title="Define Memory Instructions">
    ...
    <Frame>
      <img src="/images/aik-memory-instructions.png" alt="AI Knowledge Memory Instructions" />
    </Frame>
  ...
  <Step title="Configure Tool Memory">
    ...
    <Frame>
      <img src="/images/aik-tool-memory.png" alt="AI Knowledge Tool Memory" />
    </Frame>
  ...
  <Step title="Test Memory Effectiveness">
    ...
    <Frame>
      <img src="/images/aik-memory-testing.png" alt="AI Knowledge Memory Testing" />
    </Frame>
