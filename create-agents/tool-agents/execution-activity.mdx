...
<Frame>
  <img src="/images/execution-activity-overview.png" alt="Execution & Activity Overview" />
</Frame>
...
<Frame>
  <img src="/images/event-system.png" alt="Event System" />
</Frame>
...
<Steps>
  <Step title="Request Initiation">
    ...
    <Frame>
      <img src="/images/request-initiation.png" alt="Request Initiation" />
    </Frame>
  ...
  <Step title="Parameter Validation">
    ...
    <Frame>
      <img src="/images/parameter-validation.png" alt="Parameter Validation" />
    </Frame>
  ...
  <Step title="Execution">
    ...
    <Frame>
      <img src="/images/tool-execution.png" alt="Tool Execution" />
    </Frame>
  ...
  <Step title="Result Processing">
    ...
    <Frame>
      <img src="/images/result-processing.png" alt="Result Processing" />
    </Frame>
  ...
  <Step title="Response Delivery">
    ...
    <Frame>
      <img src="/images/response-delivery.png" alt="Response Delivery" />
    </Frame>
...
<Tabs>
  <Tab title="Activity View">
    ...
    <Frame>
      <img src="/images/activity-view.png" alt="Activity View" />
    </Frame>
  ...
  <Tab title="Event API">
    ...
    <Frame>
      <img src="/images/event-api.png" alt="Event API" />
    </Frame>
    ...
    **Example usage**:
    ```javascript
    // Query recent tool execution events
    const events = await prisme.events.query({
      types: ['tool.execution.*'],
      sources: ['workspace:my-workspace'],
      timeRange: {
    ...
    const subscription = prisme.events.subscribe(
  ...
  <Tab title="Dashboard Visualizations">
    Graphical dashboards for performance monitoring and trend analysis.
    
    <Frame>
      <img src="/images/dashboard-visualizations.png" alt="Dashboard Visualizations" />
    </Frame>
...
<Steps>
  <Step title="Identify the Issue">
    ...
    <Frame>
      <img src="/images/identify-issue.png" alt="Identify Issue" />
    </Frame>
  ...
  <Step title="Trace Execution Flow">
    ...
    <Frame>
      <img src="/images/trace-execution.png" alt="Trace Execution" />
    </Frame>
  ...
  <Step title="Compare with Successful Executions">
    ...
    <Frame>
      <img src="/images/compare-executions.png" alt="Compare Executions" />
    </Frame>
  ...
  <Step title="Implement and Verify Fixes">
    ...
    <Frame>
      <img src="/images/verify-fixes.png" alt="Verify Fixes" />
    </Frame>
...
<Steps>
  <Step title="Set Up Real-Time Dashboards">
    ...
    <Frame>
      <img src="/images/realtime-dashboards.png" alt="Real-Time Dashboards" />
    </Frame>
  ...
  <Step title="Configure Alerts">
    ...
    <Frame>
      <img src="/images/alert-configuration.png" alt="Alert Configuration" />
    </Frame>
  ...
  <Step title="Implement Event Subscribers">
    ...
    <Frame>
      <img src="/images/event-subscribers.png" alt="Event Subscribers" />
    </Frame>
  ...
  <Step title="Monitor Service Health">
    ...
    <Frame>
      <img src="/images/service-health.png" alt="Service Health" />
    </Frame>
...
<Steps>
  <Step title="Access the Activity Log">
    ...
    <Frame>
      <img src="/images/aik-activity-log.png" alt="AI Knowledge Activity Log" />
    </Frame>
  ...
  <Step title="Monitor Tool Usage">
    ...
    <Frame>
      <img src="/images/aik-tool-monitoring.png" alt="AI Knowledge Tool Monitoring" />
    </Frame>
  ...
  <Step title="Analyze Conversation Flows">
    ...
    <Frame>
      <img src="/images/aik-conversation-analysis.png" alt="AI Knowledge Conversation Analysis" />
    </Frame>
  ...
  <Step title="Export Activity Data">
    ...
    <Frame>
      <img src="/images/aik-activity-export.png" alt="AI Knowledge Activity Export" />
    </Frame>
