...
<Frame>
  <img src="/images/tool-integration-overview.png" alt="Tool Integration Overview" />
</Frame>
...
<Tabs>
  <Tab title="No-Code in AI Knowledge">
    ...
    <Frame>
      <img src="/images/ai-knowledge-tool-configuration.png" alt="AI Knowledge Tool Configuration" />
    </Frame>
  ...
  <Tab title="Low-Code in AI Builder">
    ...
    <Frame>
      <img src="/images/ai-builder-low-code.png" alt="AI Builder Low-Code" />
    </Frame>
  ...
  <Tab title="Code-Based in AI Builder">
    Develop advanced integrations with Python and Node.js in AI Builder.
    
    <Frame>
      <img src="/images/ai-builder-code-based.png" alt="AI Builder Code-Based" />
    </Frame>
...
<Steps>
  <Step title="Access Tool Configuration">
    ...
    <Frame>
      <img src="/images/ai-knowledge-tools-section.png" alt="AI Knowledge Tools Section" />
    </Frame>
  ...
  <Step title="Select Tool Type">
    ...
    <Frame>
      <img src="/images/ai-knowledge-tool-selection.png" alt="AI Knowledge Tool Selection" />
    </Frame>
  ...
  <Step title="Configure Tool Parameters">
    ...
    <Frame>
      <img src="/images/ai-knowledge-tool-parameters.png" alt="AI Knowledge Tool Parameters" />
    </Frame>
  ...
  <Step title="Connect to Backend">
    ...
    <Frame>
      <img src="/images/ai-knowledge-backend-connection.png" alt="AI Knowledge Backend Connection" />
    </Frame>
  ...
  <Step title="Test and Validate">
    ...
    <Frame>
      <img src="/images/ai-knowledge-tool-testing.png" alt="AI Knowledge Tool Testing" />
    </Frame>
...
<Steps>
  <Step title="Create an Automation">
    ...
    <Frame>
      <img src="/images/ai-builder-create-automation.png" alt="AI Builder Create Automation" />
    </Frame>
  ...
  <Step title="Define Input Schema">
    ...
    <Frame>
      <img src="/images/ai-builder-input-schema.png" alt="AI Builder Input Schema" />
    </Frame>
  ...
  <Step title="Implement Logic">
    ...
    <Frame>
      <img src="/images/ai-builder-implement-logic.png" alt="AI Builder Implement Logic" />
    </Frame>
    
    Implementation options include:
    - Visual workflow with built-in actions
    - Custom code blocks (Python/Node.js)
    - Conditional branching and loops
    - Error handling and retries
  ...
  <Step title="Format Response">
    ...
    <Frame>
      <img src="/images/ai-builder-format-response.png" alt="AI Builder Format Response" />
    </Frame>
  ...
  <Step title="Test and Debug">
    ...
    <Frame>
      <img src="/images/ai-builder-test-debug.png" alt="AI Builder Test and Debug" />
    </Frame>
...
<Steps>
  <Step title="Register the Tool">
    ...
    <Frame>
      <img src="/images/register-tool-for-aik.png" alt="Register Tool for AI Knowledge" />
    </Frame>
  ...
  <Step title="Configure in AI Knowledge">
    ...
    <Frame>
      <img src="/images/configure-tool-in-aik.png" alt="Configure Tool in AI Knowledge" />
    </Frame>
  ...
  <Step title="Test in Context">
    ...
    <Frame>
      <img src="/images/test-tool-in-context.png" alt="Test Tool in Context" />
    </Frame>
...
<Frame>
  <img src="/images/activity-debugging.png" alt="Activity Debugging" />
</Frame>
