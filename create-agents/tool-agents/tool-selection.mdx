...
<Frame>
  <img src="/images/tool-selection-overview.png" alt="Tool Selection Overview" />
</Frame>
...
<Tabs>
  <Tab title="LLM-Based Selection">
    ...
    <Frame>
      <img src="/images/llm-based-selection.png" alt="LLM-Based Selection" />
    </Frame>
  ...
  <Tab title="Rule-Based Selection">
    ...
    <Frame>
      <img src="/images/rule-based-selection.png" alt="Rule-Based Selection" />
    </Frame>
  ...
  <Tab title="Hybrid Approach">
    ...
    <Frame>
      <img src="/images/hybrid-selection.png" alt="Hybrid Selection" />
    </Frame>
...
<Steps>
  <Step title="Craft Clear Tool Descriptions">
    ...
    <Frame>
      <img src="/images/tool-descriptions.png" alt="Tool Descriptions" />
    </Frame>
  ...
  <Step title="Provide Selection Guidelines">
    ...
    <Frame>
      <img src="/images/selection-guidelines.png" alt="Selection Guidelines" />
    </Frame>
  ...
  <Step title="Implement Parameter Extraction">
    ...
    <Frame>
      <img src="/images/parameter-extraction.png" alt="Parameter Extraction" />
    </Frame>
...
<Steps>
  <Step title="LLM Pre-Selection with Rule Validation">
    ...
    <Frame>
      <img src="/images/llm-preselection.png" alt="LLM Pre-Selection" />
    </Frame>
  ...
  <Step title="Rule-Based Filtering with LLM Ranking">
    ...
    <Frame>
      <img src="/images/rule-filtering.png" alt="Rule-Based Filtering" />
    </Frame>
  ...
  <Step title="Context-Aware Selection Logic">
    ...
    <Frame>
      <img src="/images/context-aware-selection.png" alt="Context-Aware Selection" />
    </Frame>
...
<Steps>
  <Step title="Configure Tool Descriptions">
    ...
    <Frame>
      <img src="/images/aik-tool-descriptions.png" alt="AI Knowledge Tool Descriptions" />
    </Frame>
  ...
  <Step title="Set Tool Selection Instructions">
    ...
    <Frame>
      <img src="/images/aik-selection-instructions.png" alt="AI Knowledge Selection Instructions" />
    </Frame>
  ...
  <Step title="Add Usage Examples">
    ...
    <Frame>
      <img src="/images/aik-usage-examples.png" alt="AI Knowledge Usage Examples" />
    </Frame>
  ...
  <Step title="Test and Refine">
    ...
    <Frame>
      <img src="/images/aik-test-refine.png" alt="AI Knowledge Test and Refine" />
    </Frame>
