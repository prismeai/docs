...
Rate limiting is one of the governance controls built into the unified foundation, keeping the shared, multi-tenant platform stable and fair for every organization.
