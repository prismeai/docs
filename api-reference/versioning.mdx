...
<Frame>
  <img src="/images/api-versioning.png" alt="Prisme.ai API Versioning" />
</Frame>
...
<Frame>
  <img src="/images/api-version-lifecycle.png" alt="API Version Lifecycle" />
</Frame>
...
<CardGroup cols={4}>
  ...
  <Card title="Retired" icon="archive">
    - No longer available
...
Prisme.ai maintains a detailed changelog for each API version:

<Accordion title="v2 Changelog">
  **v2.5.0 (March 2025)**
  - Added support for multimodal content in AI SecureChat
  - Extended agent capabilities with new tool integrations
  - Added batch processing endpoints for knowledge bases
  - Improved performance for large document processing
  
  **v2.4.0 (January 2025)**
  - Added advanced filtering options to list endpoints
  ...
  **v2.3.0 (November 2024)**
  - Introduced template management endpoints
  - Added support for custom embeddings
  - Enhanced rate limit headers with additional information
  - Improved error messages for validation failures
  
  **v2.2.0 (September 2024)**
  - Added advanced RAG configuration options
  - Introduced workspace-level settings API
  ...
  **v2.1.0 (July 2024)**
  ...
  - Introduced document processing enhancements
  - Added support for conversation summaries
  
  **v2.0.0 (May 2024)**
  - Initial release of v2 API
</Accordion>

<Accordion title="v3 Changelog (Beta)">
  **v3.0.0-beta.3 (March 2025)**
  - Enhanced multimodal capabilities
  - Improved agent collaboration framework
  - Streamlined knowledge operations
  - Introduced real-time metrics and observability
  
  **v3.0.0-beta.2 (February 2025)**
  - Added advanced tool integration options
  - Restructured agent configuration model
  - Enhanced performance for large-scale operations
  - Introduced new event subscription model
  
  **v3.0.0-beta.1 (January 2025)**
  - Initial beta release of v3 API
  - Redesigned authentication and permission model
