...
<Accordion title="Microservices Architecture">
  ...
  - **api-gateway**: Authentication, session management, and request routing
  - **prisme.ai-workspaces**: Workspace and project management
  - **runtime**: Automation execution and event processing
  - **ai-securechat**: Conversation and document management
  - **ai-knowledge**: Knowledge base and RAG operations
  - **ai-store**: Agent discovery and sharing
</Accordion>

<Accordion title="Object Model">
  The Prisme.ai platform organizes resources in a hierarchical structure:
  
  1. **Organizations**: Top-level containers for users and workspaces
  2. **Workspaces**: Logical containers for projects and resources
  3. **Resources**: Specific instances like agents, knowledge bases, etc.
  
  Most API operations will require you to specify the workspace context in which you're operating, typically through the URL path or request body.
</Accordion>
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="comments"
  >
    Manage conversations, documents, and chat functionality
  </Card>
  <Card
    title="AI Knowledge"
    icon="database"
  >
    Create and query knowledge bases with RAG capabilities
  </Card>
  <Card
    title="AI Store"
    icon="store"
  >
    Discover, create, and share AI agents
  </Card>
  <Card
    title="AI Builder"
    icon="hammer"
  ...
  <Card
    ...
    icon="shield"
  >
    Manage access control, quotas, and usage
  </Card>
</CardGroup>
