...
<Note>**Screenshot to add:** screenshot of the workspace settings page with the Name, Description, and Photo fields filled in, and the workspace id highlighted in the URL bar.</Note>
...
<Note>**Screenshot to add:** screenshot of the Menu Editor in AI Governance with a menu item expanded, the "Add Feature" dropdown open showing "Agent Feature" and "Template Feature" options, and a Template Feature row already added with Slug, Template ID, Label fields.</Note>
...
<Note>**Screenshot to add:** screenshot of the "Create new workspace" wizard in Builder showing the configuration form rendered from the schema above — Website to crawl input, Brand name input, OpenAI API Key field with a key icon.</Note>
...
<Note>**Screenshot to add:** screenshot of the New Workspace modal in Builder showing tiles: "From scratch" (code icon), the freshly published template (with its label and description), and "Import ZIP" (upload icon).</Note>
