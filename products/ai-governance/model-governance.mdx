...
A platform administrator can manage a model's availability at three levels of severity. Each level has a different effect on what the runtime accepts, what surfaces in UI pickers, and whether the model is auto-pruned from organization allowlists.

### State matrix

| Flag | Set by | Runtime | Org "Allowed models" panel | Agent-level pickers | Auto-pruned from `org.allowed_models` |
|------|--------|---------|----------------------------|---------------------|---------------------------------------|
