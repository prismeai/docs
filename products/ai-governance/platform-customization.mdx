...
Branding and navigation are part of the same two-level model as the rest of Governe: central governance sets the platform-wide defaults, and each organization adapts appearance and navigation within those guardrails to match its own brand identity.
