...
**collections** is the only module natively available, however it is meant to be used through [**Collection** application](https://docs.prisme.ai/apps-store/marketplace/collection).  
