...
**collections** is a natively available module, however it is meant to be used through the [**Collection** application](https://docs.prisme.ai/apps-store/marketplace/collection).
