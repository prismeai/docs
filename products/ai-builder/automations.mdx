...
<Frame>
  <img src="/images/ai-builder.png" alt="AI Builder Automations Interface" />
</Frame>
...
<Properties>
  ...
  <Property name="Socket Scope" value="Available for the current websocket connection">
  ...
  <Property name="Config Scope" value="Workspace and app configuration">
    Access pattern: `{{config.variable}}`
    
    Contains the workspace configuration defined in the workspace settings.
  </Property>
  
  <Property name="$workspace Scope" value="Read-only workspace information">
...
<Frame>
  <img src="/images/interpolation_brackets.png" alt="Variable Interpolation" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Try/Catch" icon="shield">
...
<CardGroup cols={2}>
  <Card title="Set Instruction" icon="pen">
    ...
    You can also use expressions in the value parameter:
  ...
  <Card title="Delete Instruction" icon="trash">
...
<CardGroup cols={2}>
  <Card title="Fetch Instruction" icon="globe">
    ...
    - fetch:
        ...
        output: fullResponse
    # Access via `{{fullResponse.body}}` and `{{fullResponse.headers}}`
    ```
    ...
    For AWS services, you can use AWS Signature V4 authentication:
    ...
    For handling streaming SSE responses:
  ...
  <Card title="Emit Instruction" icon="bolt">
    ...
    Events size must not exceed 100KB.
  </Card>
  
  <Card title="Wait Instruction" icon="clock">
  ...
  <Card title="Rate Limit Instruction" icon="gauge">
...
<CardGroup cols={2}>
  <Card title="Auth Instruction" icon="key">
    ...
    You can also forward source workspace authentication:
  ...
  <Card title="User Topic Instructions" icon="users">
...
<CardGroup cols={2}>
  ...
  <Card title="State Management" icon="database">
    <p>Handle data appropriately across scopes:</p>
    <ul>
      <li>Use appropriate memory scopes for different data needs</li>
      <li>Clean up temporary variables when finished</li>
      <li>Initialize variables before using them</li>
      <li>Be mindful of persistence requirements</li>
    </ul>
  </Card>
  
  <Card title="Security Best Practices" icon="lock">
    <p>Keep your automations secure:</p>
    <ul>
      <li>Store sensitive data in secrets</li>
      <li>Validate inputs from external sources</li>
      <li>Implement rate limiting for external APIs</li>
      <li>Use proper authentication for API calls</li>
    </ul>
  </Card>
  ...
  <Card title="Performance Optimization" icon="gauge-high">
    ...
    <ul>
      ...
      <li>Implement batching for large data sets</li>
  ...
  <Card title="Testing" icon="vial">
    ...
    <ul>
      ...
      <li>Use Activity view to review execution history</li>
    </ul>
  </Card>
</CardGroup>
