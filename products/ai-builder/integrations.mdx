...
The sidebar entry is now named **Imports**. The installation modal still opens the **App Store**, where you choose the package to add to the workspace.
...
<Steps>
  ...
  <Step title="Browse the App Store">
    Click **+** next to Imports, then choose **Browse App Store**.
