---
title: "Imports"
description: "Install and configure apps, connectors, MCP servers, and custom code in Builder"
---

<Frame>
  <img src="/images/ai-builder-imports.png" alt="Builder Imports with the App Store modal open" />
</Frame>

Imports extend a Builder workspace with reusable apps, connectors, MCP servers, custom code, and automation instructions. Use them when a page or automation needs to call an external system, reuse packaged logic, or expose a tool to agents. Builder is also where you build your own connectors and MCP servers and declare them as platform- or tenant-level capabilities, build once, reuse everywhere, and pool security and quality across the foundation.
...
<Frame>
  <img src="/images/ai-builder-imports.png" alt="Builder App Store modal for installing imports" />
</Frame>
