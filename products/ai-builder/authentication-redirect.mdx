...
Because the whole platform is governed by design, sign-in is centralized: every page and app you build in Builder authenticates through the same SSO-backed flow. When you embed a Prisme.ai page or app in another product (a mobile app, an intranet portal, an iframe), users have to sign in. By default, a user who signs in from the platform root lands on the **Builder**. This guide shows how to send them to **your page** instead.
