---
title: 'Use Cases'
description: 'Explore real-world applications built with Builder across various industries and functions'
---


As the full-code door onto the foundation, Builder lets technical teams assemble agents, agentic workflows, and React front-ends into sophisticated AI applications across a wide range of industries and business functions, the building blocks of the AI Information System of tomorrow. This guide explores real-world use cases and implementation examples to inspire your own Builder projects.
...
<Tabs>
  <Tab title="Corporate Knowledge Base">
    ...
    **Implementation Highlights**:
    - Uses Knowledges for advanced RAG configuration
...
Ready to build your own AI application with Builder? Get started with these resources:

<CardGroup cols={2}>
  <Card title="Builder Documentation" icon="book" href="/products/ai-builder/overview">
    Step-by-step guidance for bringing your AI application to life
  </Card>
  
  <Card title="Tutorials" icon="chart-line" href="/resources/tutorials/ai-builder-custom-apps">
    Detailed examples of successful Builder implementations
  </Card>
</CardGroup>