...
<CardGroup cols={3}>
  <Card title="Solution Templates" icon="puzzle-piece" href="/resources/templates/overview">
    Pre-built templates for common use cases to accelerate your development
  </Card>
  
  <Card title="AI Builder Documentation" icon="book" href="/products/ai-builder/overview">
