...
Once a workspace is polished, an org admin can publish it as a template so other users can clone it from the **Create new workspace** screen in Builder. The publishing step happens in **Govern → Menu Editor** — see [Workspace Templates](/products/ai-governance/workspace-templates) for the full walkthrough.
