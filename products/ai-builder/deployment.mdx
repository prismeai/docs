...
<Tabs>
  <Tab title="Single Workspace">
    <Frame>
      <img src="/images/single-workspace-deployment.png" alt="Single Workspace Strategy" />
    </Frame>
  ...
  <Tab title="Multi-Workspace">
    <Frame>
      <img src="/images/multi-workspace-deployment.png" alt="Multi-Workspace Strategy" />
    </Frame>
  ...
  <Tab title="Multi-Instance">
    <Frame>
      <img src="/images/multi-instance-deployment.png" alt="Multi-Instance Strategy" />
    </Frame>
...
<Steps>
  <Step title="Configure Git Repository">
    ...
    <Frame>
      <img src="/images/git-configuration.png" alt="Git Repository Configuration" />
    </Frame>
  ...
  <Step title="Push to Repository">
    ...
    <Frame>
      <img src="/images/push-repository.png" alt="Push to Repository" />
    </Frame>
  ...
  <Step title="Pull from Repository">
    ...
    <Frame>
      <img src="/images/pull-repository.png" alt="Pull from Repository" />
    </Frame>
...
<AccordionGroup>
  <Accordion title="Built-in Deployment">
    <Frame>
      <img src="/images/built-in-deployment.png" alt="Built-in Deployment" />
    </Frame>
  ...
  <Accordion title="CI/CD Integration">
    <Frame>
      <img src="/images/cicd-integration.png" alt="CI/CD Integration" />
    </Frame>
  ...
  <Accordion title="API-Based Deployment">
    <Frame>
      <img src="/images/api-deployment.png" alt="API-Based Deployment" />
    </Frame>
...
<Steps>
  ...
  <Step title="Conditional Logic">
    ...
    do:
      - var: environment
        value: "{{workspace.slug | includes: 'prod', 'production' | if: 'production', 'development'}}"
  ...
  <Step title="Feature Flags">
    ...
    features:
      newDashboard: "{{workspace.slug | includes: 'dev', 'staging' | if: true, false}}"
      betaFeatures: "{{workspace.slug | includes: 'dev' | if: true, false}}"
    ```
    
    Then in your pages:
    ```yaml
    - slug: NewDashboard
      template.if: "{{features.newDashboard}}"
    ```
  </Step>
</Steps>
