...
<AccordionGroup>
  <Accordion title="Event Types">
    <Card>
      ...
      Description:
      Platform-generated events for key operations
      Examples:
      page load, block mount, automation start/end, error occurrence
    </Card>
    <Card>
      <h3>
      Custom Events</h3>
      ...
      Description:
      User-defined events for application-specific logic
      Examples:
      form submission, data request, process completion
    </Card>
    <Card>
      <h3>
      UI Events</h3>
      ...
      Description:
      User interaction events from blocks and pages
      Examples:

      button click, selection change, data input
    </Card>
    <Card>
      <h3>
      External Events</h3>
      ...
      Examples:
      third-party notifications, scheduled triggers, external system callbacks
    </Card>
  </Accordion>
  <Accordion title="Event Communication Channels">
    <Card>
      ...
      UI updates, event streaming, long-running processes
    </Card>
    <Card>
      <h3>
      HTTP</h3>
      ...
      Description:
      Request-response communication for APIs
      Used for:
      External system integration, data fetching, authentication
    </Card>
    <Card>
      <h3>
      Event Broker</h3>
      ...
      Description:
      Internal communication between automations

      Default implementation:
      Redis Streams for reliable, ordered event delivery
    </Card>
  </Accordion>
  <Accordion title="Event Processing">
    <Card>
      ...
      Description:
      Immediate handling with response

      Used for:
      Direct API calls, user-facing operations requiring immediate feedback
    </Card>
    <Card>
      <h3>
      ...
      Queued handling without waiting
      Used for:

      Background tasks, long-running operations, scheduled processes
    </Card>
    <Card>
      <h3>
      ...
      Tracking related events across the system

      Implementation:

      Correlation IDs to trace event chains through the system
    </Card>
  </Accordion>
</AccordionGroup>
