---
title: "Overview"
description: "Builder: the full-code way to build agents, workflows, and React front-ends, fully integrated. Every Prisme.ai product is built with it, and so can yours."
---

<Frame>
  <img src="/images/flow-builder.svg" alt="How Builder works: build pages, automations and apps; test and trace; version with Git; deploy" />
</Frame>

Builder is the **full-code way onto the foundation**, the workspace where technical teams build full-stack. Here you can create **agents**, **agentic workflows/automations**, and **React front-ends**, or **all of them at once**, fully integrated, to deliver one fluid digital experience rather than disconnected pieces. Connect enterprise systems, orchestrate backend logic, and inspect runtime activity, all from the same place, all versioned as code.

<Frame caption="From no-code, full-code or a prompt: a web app, an agent, a workflow, an agentic workflow, or full-stack.">
  <img src="/images/build-flow.svg" alt="Builder produces web apps, agents, workflows, agentic workflows or full-stack, from no-code, full-code or a prompt" />
</Frame>
...
In fact, every Prisme.ai product, from Chat to Governe, is built with Builder. That is the clearest proof of what it can do: with the same tool, you extend the platform with your own custom products, on the same governed foundation.

Builder is organized around source-based pages, backend automations, imports, files, activity traces, and workspace settings.
