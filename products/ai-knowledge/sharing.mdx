...
The foundation is governed by design, and knowledge bases are no exception: they support fine-grained access control, letting you share them with specific users, groups, or your entire organization. Each person or group receives a role that determines what they can do, the same role-based model that governs [Collections](/products/ai-collection/overview) and the rest of the platform.
