...
Connectors let you automatically sync documents from external platforms. Instead of manually uploading files, connect to the source and let AI Knowledge keep your knowledge base up to date.
...
Open AI Knowledge and go to **Connectors** to see:
...
Most connectors require OAuth authentication:

1. Click **Connect**
2. Sign in to the external service in the popup
3. Grant permissions when prompted
4. Return to AI Knowledge
