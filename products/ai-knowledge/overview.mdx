---
title: "Knowledges"
description: "Knowledges: turn documents and websites into knowledge your agents can search with RAG."
---

<Frame>
  <img src="/images/flow-knowledges.svg" alt="How Knowledges works: sources ingested (chunk and embed) into a knowledge base that grounds agents via RAG" />
</Frame>

<Frame>
  <img src="/images/ai-knowledge-home.png" alt="Knowledges Dashboard" />
</Frame>

Knowledges is the **knowledge layer of the foundation**, where you turn your organization's unstructured content into something agents can actually use. Upload files, crawl websites, or connect external sources like SharePoint, then attach the knowledge base to any agent so its answers are grounded in *your* content, not the model's guesswork. (For structured, tabular data, its counterpart is [Collections](../ai-collection/overview).)
