...
3. Configure crawl settings:
   - **Max pages** - Limit how many pages to crawl
   - **Max depth** - How many links deep to follow
...
Control who can use this knowledge base:

1. Go to Settings > Sharing
2. Choose visibility level
3. For restricted access, add specific users or groups
