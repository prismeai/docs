...
description: "The Prisme.ai product suite — AI agents, governance, data, analytics, and knowledge management"
---
...
<CardGroup cols={2}>
  ...
  <Card title="AI Knowledge" icon="book" href="/products/ai-knowledge/overview">
    Document management, RAG configuration, and knowledge base administration
  </Card>
</CardGroup>
...
```
┌──────────────────────────┐      ┌──────────────────────────┐
│  Builtin App (React)     │      │  Backend Workspace(s)    │
│                          │      │                          │
│  builtin-apps/<slug>/    │─────►│  workspaces/<slug>/      │
│    manifest.json         │ REST │    automations/v1/       │
│    src/App.tsx           │ SSE  │    imports/              │
│                          │      │    security.yml          │
└──────────────────────────┘      └──────────────────────────┘
```
...
| AI Knowledge | `ai-knowledge` | `storage` | — |
