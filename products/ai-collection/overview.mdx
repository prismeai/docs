...
<Note>
Under the hood, Collections is built on the [Collection module](/apps-store/marketplace/collection), a database abstraction (MongoDB or PostgreSQL, mutualized or dedicated). The product adds the no-code interface; developers can use the module directly in [Builder](/products/ai-builder/overview).
</Note>
