...
|---------|-------|-------------|----------|------------|--------|-------|-----------|-------------|
| `simple` | 1 | No | No | No | Working | Knowledge only | 1 | 50K |
| `workflow` | 2 | No | No | No | Working + Session | Knowledge + Custom | 10 | 100K |
| `agent_light` | 3 | Yes | No | No | Working + Session | System (todo, budget) + Knowledge + Custom | 10 | 100K |
| `agent_full` | 4 | Yes | Yes | Yes | All (incl. long-term) | All system + Knowledge + Custom | 30 | 300K |
| `orchestrator` | 5 | Yes | Yes | Yes | All | All + Delegation | 50 | 300K |
