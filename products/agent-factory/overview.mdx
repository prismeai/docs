...
| `budget_get_remaining` | Check remaining token/cost budget | Agent Light+ |
...
| [AI Governance](/products/ai-governance/overview) | API key validation, org context | Cross-workspace |
