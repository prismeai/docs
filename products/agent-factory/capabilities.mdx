...
| Type | Description |
|------|-------------|
| **Knowledge Base** | Search documents uploaded to AI Knowledge |
...
Higher profiles unlock additional system tools:

| Tool | Description | Available From |
|------|-------------|----------------|
| **File Search** | Search conversation attachments | Light Agent |
| **Task Management** | Create and track task lists | Light Agent |
| **Budget Check** | Monitor token/cost usage | Light Agent |
| **Planning** | Create step-by-step plans before acting | Full Agent |
| **Reflection** | Self-evaluate progress and quality | Full Agent |
| **Human Approval** | Request user approval for actions | Full Agent |
| **Agent Delegation** | Delegate tasks to other agents | Orchestrator |
