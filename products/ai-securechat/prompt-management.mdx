...
<Info>
  A dedicated administration UI for creating, editing, and organizing prompt templates is **coming soon**. In the meantime, administrators can manage prompts directly through the **prompt-library** workspace's Collection in AI Builder.
</Info>
