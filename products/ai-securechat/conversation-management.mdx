---
title: 'Conversation Management in AI SecureChat'
...
<Frame>
  <img src="/images/conversation-anatomy.png" alt="Anatomy of a Conversation" />
</Frame>
...
<Steps>
  ...
  <Step title="Set conversation parameters (optional)">
    Click the settings icon (⚙️) next to the conversation title to adjust parameters.

    <Frame>
      <img src="/images/conversation-parameters.png" alt="Conversation Parameters" />
    </Frame>

    You can configure:
    - Model selection (if multiple are available)
    - Special instructions or system prompts
  </Step>
</Steps>
...
<Steps>
  <Step title="Access your conversations">
    Open the conversation sidebar by clicking the sidebar icon or using the keyboard shortcut (Ctrl/Cmd + Shift + C).

    <Frame>
      <img src="/images/conversation-sidebar.png" alt="Conversation Sidebar" />
    </Frame>
  ...
  <Step title="Select a conversation">
    ...
    <Frame>
      <img src="/images/select-conversation.png" alt="Selecting a Conversation" />
    </Frame>
  ...
  <Step title="Delete conversations">
    ...
    <Frame>
      <img src="/images/conversation-delete.png" alt="Delete Conversations" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Open sharing settings">
    ...
    <Frame>
      <img src="/images/conversation-share-button.png" alt="Conversation Share Button" />
    </Frame>
  </Step>
  ...
  <Step title="Choose sharing options">
    ...
    <Frame>
      <img src="/images/sharing-options.png" alt="Sharing Options" />
    </Frame>

    Options include:
    - **View only**: Recipients can see the conversation but not contribute
    - **Full collaboration**: Recipients have equal access to the conversation
  </Step>

  <Step title="Add recipients">
    Enter the email addresses or usernames of people you want to share with.

    <Frame>
      <img src="/images/add-recipients.png" alt="Adding Recipients" />
    </Frame>

    You can also share with groups if your organization has configured them.
  </Step>
  ...
  <Step title="Finalize sharing">
    ...
    <Frame>
      <img src="/images/share-confirmation.png" alt="Share Confirmation" />
    </Frame>

    Recipients will receive a notification and can access the conversation through their own AI SecureChat interface.
  </Step>
</Steps>
...
<Steps>
  <Step title="Scroll through history">
    ...
    <Frame>
      <img src="/images/conversation-scrolling.png" alt="Scrolling Through Conversation" />
    </Frame>
  ...
  <Step title="Jump to specific points">
    ...
    <Frame>
      <img src="/images/timeline-navigation.png" alt="Timeline Navigation" />
    </Frame>
...
<Frame>
  <img src="/images/message-operations.png" alt="Message Operations" />
</Frame>
...
<Accordion title="Context Window Explained">
  ...
  <Frame>
    <img src="/images/context-window.png" alt="Context Window Visualization" />
  </Frame>
...
<Accordion title="Managing Context Effectively">
  ...
  <Frame>
    <img src="/images/context-management.png" alt="Context Management" />
  </Frame>
...
<Accordion title="Manual Context Control">
  ...
  <Frame>
    <img src="/images/manual-context-control.png" alt="Manual Context Control" />
  </Frame>
</Accordion>
...
<Tabs>
  <Tab title="Deletion">
    ...
    <Steps>
      ...
      <Step title="Access trash">
        Go to Settings > Trash to view recently deleted conversations.
      </Step>
      <Step title="Restore or permanently delete">
        Recover conversations from trash or permanently remove them.
      </Step>
    </Steps>
