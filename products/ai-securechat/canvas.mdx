---
title: 'Canvas'
description: 'Master the collaborative content creation workspace in Chat'
---

<Frame>
  <img src="/images/securechat-conversation-active.png" alt="Chat Canvas" />
</Frame>

Prisme.ai Canvas is Chat’s powerful collaborative workspace for content creation, keeping all data securely within your infrastructure. When an agent in Chat produces something more than a message, an artifact you need to draft, edit, and refine, Canvas is where that work happens: a rich environment for written documents, code, or visual presentations, all with AI assistance.
...
<Frame>
  <img src="/images/securechat-canvas-heatmap.png" alt="Canvas Workspace" />
</Frame>
...
<Frame>
  <img src="/images/securechat-conversation-active.png" alt="Canvas Code Workspace" />
</Frame>
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    href="/products/agent-factory/slides"
  >
