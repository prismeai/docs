---
title: 'Canvas in AI SecureChat'
description: 'Master the collaborative content creation workspace in AI SecureChat'
---

<Frame>
  <img src="/images/canvas-hero.png" alt="AI SecureChat Canvas" />
</Frame>

Canvas is AI SecureChat's powerful collaborative content creation workspace. It provides a rich environment for drafting, editing, and refining content with AI assistance, whether you're creating written documents, code, or visual presentations.

## Overview

Canvas transforms AI SecureChat from a conversational interface into a full-featured workspace where you can:
...
<Steps>
  <Step title="Open Canvas from conversation">
    ...
    <Frame>
      <img src="/images/open-canvas-button.png" alt="Opening Canvas from a Conversation" />
    </Frame>
  </Step>
  
  <Step title="Select workspace type">
    Choose the type of Canvas workspace you want to open:
    
    <Frame>
      <img src="/images/canvas-workspace-selection.png" alt="Canvas Workspace Selection" />
    </Frame>
...
<Tabs>
  <Tab title="Text Formatting">
    <Frame>
      <img src="/images/canvas-text-formatting.png" alt="Canvas Text Formatting Tools" />
    </Frame>
  ...
  <Tab title="Layout Options">
    <Frame>
      <img src="/images/canvas-layout-options.png" alt="Canvas Layout Options" />
    </Frame>
  ...
  <Tab title="Content Elements">
    <Frame>
      <img src="/images/canvas-content-elements.png" alt="Canvas Content Elements" />
    </Frame>
  ...
  <Tab title="Document Structure">
    <Frame>
      <img src="/images/canvas-document-structure.png" alt="Canvas Document Structure" />
    </Frame>
...
<Frame>
  <img src="/images/canvas-ai-assistance-menu.png" alt="Canvas AI Assistance Menu" />
</Frame>
...
<AccordionGroup>
  <Accordion title="Generate Content">
    ...
    <Frame>
      <img src="/images/canvas-generate-content.png" alt="Generating Content in Canvas" />
    </Frame>
  ...
  <Accordion title="Edit & Improve">
    ...
    <Frame>
      <img src="/images/canvas-edit-improve.png" alt="Editing and Improving in Canvas" />
    </Frame>
  ...
  <Accordion title="Change Style & Tone">
    ...
    <Frame>
      <img src="/images/canvas-style-tone.png" alt="Changing Style and Tone in Canvas" />
    </Frame>
  ...
  <Accordion title="Translate">
    ...
    <Frame>
      <img src="/images/canvas-translate.png" alt="Translation in Canvas" />
    </Frame>
...
<Frame>
  <img src="/images/canvas-intelligent-menu.png" alt="Canvas Intelligent Context Menu" />
</Frame>
...
<Tabs>
  <Tab title="Editor Capabilities">
    <Frame>
      <img src="/images/canvas-code-editor.png" alt="Canvas Code Editor" />
    </Frame>
  ...
  <Tab title="Execution Environment">
    <Frame>
      <img src="/images/canvas-code-execution.png" alt="Canvas Code Execution" />
    </Frame>
  ...
  <Tab title="Live Preview">
    <Frame>
      <img src="/images/canvas-live-preview.png" alt="Canvas Live Preview" />
    </Frame>
  ...
  <Tab title="Visual Tools">
    <Frame>
      <img src="/images/canvas-visual-tools.png" alt="Canvas Visual Tools" />
    </Frame>
...
<Frame>
  <img src="/images/canvas-code-assistance-menu.png" alt="Canvas Code Assistance Menu" />
</Frame>
...
<AccordionGroup>
  <Accordion title="Generate Code">
    ...
    <Frame>
      <img src="/images/canvas-generate-code.png" alt="Generating Code in Canvas" />
    </Frame>
  ...
  <Accordion title="Improve Code">
    ...
    <Frame>
      <img src="/images/canvas-improve-code.png" alt="Improving Code in Canvas" />
    </Frame>
  ...
  <Accordion title="Documentation">
    ...
    <Frame>
      <img src="/images/canvas-documentation.png" alt="Documentation in Canvas" />
    </Frame>
  ...
  <Accordion title="Testing">
    ...
    <Frame>
      <img src="/images/canvas-testing.png" alt="Testing in Canvas" />
    </Frame>
  ...
  <Accordion title="Convert & Adapt">
    ...
    <Frame>
      <img src="/images/canvas-convert-code.png" alt="Converting Code in Canvas" />
    </Frame>
...
<Tabs>
  <Tab title="Version Comparison">
    <Frame>
      <img src="/images/canvas-code-comparison.png" alt="Code Version Comparison" />
    </Frame>
  ...
  <Tab title="Dependency Management">
    <Frame>
      <img src="/images/canvas-dependencies.png" alt="Dependency Management" />
    </Frame>
  ...
  <Tab title="Debugging Assistance">
    <Frame>
      <img src="/images/canvas-debugging.png" alt="Debugging Assistance" />
    </Frame>
...
<Frame>
  <img src="/images/canvas-multimodal.png" alt="Multimodal Capabilities in Canvas" />
</Frame>
...
<Steps>
  ...
  <Step title="Analyze visual content">
    ...
    <Frame>
      <img src="/images/canvas-image-analysis.png" alt="Image Analysis in Canvas" />
    </Frame>
  ...
  <Step title="Edit and transform">
    ...
    <Frame>
      <img src="/images/canvas-image-editing.png" alt="Image Editing in Canvas" />
    </Frame>
...
<Frame>
  <img src="/images/canvas-collaboration.png" alt="Canvas Collaboration" />
</Frame>
...
<Steps>
  <Step title="Share your Canvas">
    ...
    <Frame>
      <img src="/images/canvas-sharing.png" alt="Sharing Canvas" />
    </Frame>
  ...
  <Step title="Collaborate in real-time">
    ...
    <Frame>
      <img src="/images/canvas-realtime.png" alt="Real-time Collaboration" />
    </Frame>
  ...
  <Step title="Comment and discuss">
    ...
    <Frame>
      <img src="/images/canvas-comments.png" alt="Canvas Comments" />
    </Frame>
...
<Accordion title="Track changes">
  ...
  <Frame>
    <img src="/images/canvas-version-history.png" alt="Canvas Version History" />
  </Frame>
...
<Accordion title="Compare versions">
  See how your content has evolved over time:
  
  <Frame>
    <img src="/images/canvas-version-compare.png" alt="Comparing Canvas Versions" />
  </Frame>
  
  Comparison capabilities:
  - Side-by-side view of different versions
  - Highlighted changes between versions
  - Filtering by author or time period
  - Ability to restore specific elements from older versions
</Accordion>
...
<Accordion title="Restore previous work">
  ...
  <Frame>
    <img src="/images/canvas-version-restore.png" alt="Restoring Canvas Versions" />
  </Frame>
...
Start your work with pre-designed templates for common content types:

<Frame>
  <img src="/images/canvas-template-gallery.png" alt="Canvas Template Gallery" />
</Frame>
...
<CardGroup cols={3}>
  <Card title="Business Email" icon="envelope">
    Professional email template with customizable sections
  </Card>
  <Card title="Project Proposal" icon="file-contract">
    Structured proposal format with executive summary and details
  </Card>
  <Card title="Marketing Content" icon="bullhorn">
    Templates for blog posts, social media, and ads
  </Card>
  <Card title="Technical Documentation" icon="file-lines">
    Format for user guides and technical specifications
  </Card>
  ...
  <Card title="Academic Writing" icon="graduation-cap">
    Formats for research papers and academic content
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="Web Application" icon="globe">
    Starter templates for various web frameworks
  </Card>
  <Card title="API Backend" icon="server">
    Boilerplate for RESTful and GraphQL services
  </Card>
  <Card title="Data Analysis" icon="chart-column">
    Templates for common data processing tasks
  </Card>
  <Card title="Mobile App" icon="mobile">
    Starter code for mobile application development
  </Card>
  <Card title="Testing Suite" icon="vial">
    Test framework setup for various languages
  </Card>
  <Card title="Documentation" icon="book">
    Code documentation templates and examples
  </Card>
</CardGroup>
...
<Steps>
  <Step title="Save current Canvas as template">
    Create a reusable template from your current work:
    
    <Frame>
      <img src="/images/canvas-save-template.png" alt="Saving Canvas as Template" />
    </Frame>
  </Step>
  
  <Step title="Configure template options">
    Define template parameters and variables:
    
    <Frame>
      <img src="/images/canvas-template-options.png" alt="Canvas Template Options" />
    </Frame>
  ...
  <Step title="Share your template">
    Make templates available to others in your organization:
    
    <Frame>
      <img src="/images/canvas-share-template.png" alt="Sharing Canvas Templates" />
    </Frame>
    
    Sharing options:
    - Personal templates (just for you)
    - Team templates (for specific groups)
    - Organization templates (for everyone)
    - Public templates (if enabled by your admin)
  </Step>
</Steps>
...
<Frame>
  <img src="/images/canvas-export-options.png" alt="Canvas Export Options" />
</Frame>
...
<CardGroup cols={3}>
  <Card title="PDF" icon="file-pdf">
    Fixed-format document with preserved layout
  </Card>
  ...
  <Card title="Google Docs" icon="file-alt">
    Export directly to Google Docs (where configured)
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  ...
  <Card title="Project ZIP" icon="file-zipper">
    Complete project with directory structure
  </Card>
