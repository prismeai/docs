...
description: 'Learn how to work with images and visual content in Chat'
---

<Frame>
  <img src="/images/securechat-conversation-active.png" alt="Multimodal Chat" />
</Frame>
...
<Tabs>
  ...
  <Tab title="Supported Modalities">
    <Frame>
      <img src="/images/chat-multimodal-image-analysis.png" alt="Chat analysing an uploaded chart and returning a structured visual interpretation" />
    </Frame>
...
<Frame>
  <img src="/images/securechat-canvas-heatmap.png" alt="Image Analysis Examples" />
</Frame>
...
{/* TODO screenshot: same OCR result view as document-handling.mdx — Chat conversation showing an image upload with extracted text. Save as /images/chat-ocr-example.png. */}
