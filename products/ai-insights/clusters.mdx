...
Clusters formalizes the similarity signal you can already see on the [Agent network](/products/ai-insights/graph). It groups agents whose conversation patterns and tool usage overlap above a threshold, and surfaces the **isolated agents** that don't fit into any cluster, the analysis layer's answer to whether your fleet is consolidating into a coherent foundation or fragmenting into silos.
