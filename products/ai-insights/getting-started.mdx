...
Insights is the analysis and compliance layer of the foundation, so it becomes useful the moment your organization has at least one published agent in Agent Creator. Because every interaction is already a normalized, traceable event, there's nothing to instrument: as soon as an agent has conversations, Insights sees them. If you don't have an agent yet, build one in Agent Creator first; this page assumes you do, or that you want to explore the product with mock data.
