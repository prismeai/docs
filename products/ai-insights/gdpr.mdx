...
Compliance oversight is part of what makes Insights the analysis and compliance layer of the foundation, and the **GDPR** page is where that shows up most directly. It lets data controllers export or permanently delete a single user's footprint across the Insights data set: conversations, insights, agents, shares, and ratings.
