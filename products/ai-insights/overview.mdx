...
<Frame>
  <img src="/images/flow-insights.svg" alt="How Insights works: conversations auto-ingested, evaluated against your criteria, rolled into dashboards with GDPR oversight" />
</Frame>
...
Insights is the **analysis and compliance layer of the foundation**. Because every interaction is a normalized, traceable event, Insights can tell you what your agents are doing, how well they're doing it, and where they're falling short, while also giving you what compliance demands, including **GDPR** oversight of the conversations flowing through your agents. It pulls every conversation that runs through Agent Creator (and other connected products), evaluates them against criteria you define, and rolls the results up into dashboards you can act on.
