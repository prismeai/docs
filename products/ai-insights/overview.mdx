...
**Workspace:** `ai-insights-v2` (70 automations)
**Frontend:** `builtin-apps/ai-insights`
...
| Conversation analysis | — | Yes | Yes | Yes |
| Agent graph | — | — | Yes | Yes |
| Memory analytics | — | — | Yes | Yes |
| GDPR tools | — | — | — | Yes |
| Custom evaluation criteria | — | — | Yes | Yes |

Tier checks are performed by `_check-tier-feature` before each operation.
...
| `evaluation_templates` | Custom evaluation criteria templates |
