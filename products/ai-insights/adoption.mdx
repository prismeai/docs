...
Adoption answers: *who is using our agents, how deeply, and what should we do to grow each segment?* It's where Insights measures how well the foundation is being taken up. Once you know where adoption is thin, [Engage](/products/ai-engage/overview) is the product that drives it, announcing agents, sharing updates, and re-activating the segments this page surfaces.
...
<CardGroup cols={2}>
  ...
  <Card title="Drive adoption with Engage" icon="bullhorn" href="/products/ai-engage/overview">
    Turn these segments and recommendations into announcements and campaigns.
  </Card>
</CardGroup>
