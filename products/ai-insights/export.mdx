...
As the analysis and compliance layer of the foundation, Insights lets you take its evaluations out for downstream analysis or reporting. It provides a CSV export of analyzed conversations from any agent's [Insights](/products/ai-insights/insights) page. The export reflects whatever filters and pagination state are active at the moment you click; it doesn't fetch beyond the page contents.
