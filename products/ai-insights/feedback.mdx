...
Where the analysis layer measures quality with an LLM-as-judge, the **Feedback** page brings in the other half of the picture: what users actually thought of your agents' replies, captured as a like/dislike vote and any optional comment they left.
