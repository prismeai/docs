...
Criteria are how you tell the analysis layer what "good" means for a given agent. They're the questions the LLM is asked when it analyzes a conversation. Each criterion has an ID, a question, a type, an optional value range or option list, and a weight that contributes to the overall evaluation score.
