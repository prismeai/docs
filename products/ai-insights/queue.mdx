...
The **Queue Monitor** entry in the organization sidebar is the operational view of the analysis pipeline. Every conversation that gets analyzed flows through a managed queue with a worker pool, a daily budget, and rate limits, the same governed-by-design posture the rest of the foundation runs on. This page tells you whether the pipeline is keeping up.
