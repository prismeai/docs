...
If you need to support thousands of concurrent users per pod, follow the **Production-ready** profile and scale node counts proportionally.
...
Prisme.ai requires either a file or object storage (**recommended choice**) for models and file uploads:
...
AI Products installation also requires a **RWX filesystem** for `prismeai-functions` microservice.
