...
AI Products installation also require a **vector database**, served by **Elasticsearch / OpenSearch** — it can share the same cluster as the events store or live on a separate one.  
