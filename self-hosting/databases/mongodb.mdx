---
title: "MongoDB"
description: "Role, configuration, backup, scaling, updates and least privileges for MongoDB in Prisme.ai self-hosted deployments."
---
...
PostgreSQL can be used as an alternative — see [PostgreSQL](/self-hosting/databases/postgresql).
...
|----------|--------------------|-------|
| AWS | MongoDB Atlas (preferred), Amazon DocumentDB | DocumentDB lacks some MongoDB features — validate with Prisme.ai before committing. |
