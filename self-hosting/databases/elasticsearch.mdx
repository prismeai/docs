...
## Production targets (RPO / RTO)

| Target | Events | Vector store |
|---|---|---|
| RPO | 24 h or less | 24 h or less |
| RTO | 4 h or less | conditioned on re-vectorization cost |
| Retention | 14 days of snapshots or more | 14 days or more |
| Criticality | Carries audit and GDPR compliance | Reconstructible but costly |

<Note>
Backing up the vector store is far cheaper than rebuilding it: a full re-vectorization costs embeddings plus days of processing.
</Note>

Full requirements and the go/no-go checklist are in [Production Readiness](/self-hosting/production-readiness/requirements).
