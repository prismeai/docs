...
- **`${aikPrefix}`** corresponds to the `vectorStore.vectorIndexPrefix` key in the Storage / AI Knowledge workspace configuration.
...
Prismeai automatically configures ILM policies to automate index rollover + segments merging when their primary shard reach **40 GB**, as recommended by Elasticsearch/Opensearch.
