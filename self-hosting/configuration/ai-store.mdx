...
AI Store visibility is governed by the workspace’s **RBAC rules**. Chat agents within AI Store can be:
...
- **Manually** via AI Store for basic configuration and Knowledges for advanced settings.
- **Automatically** via Builder workflows
...
- **Workspace activity logs on Builder**
- **Analytics on Knowledges**
...
## Example Integration in `index.yaml` of AI Store workspace on Builder
