...
<Frame>
  <img src="/images/ai-governance-hero.png" alt="AI Governance Overview" />
</Frame>
...
To customize login options, set:
...
<CardGroup cols={2}>
  ...
  >
    Automate workspace templates and product bootstrapping
  </Card>
  <Card
    title="AI Insights"
    icon="chart-line"
  ...
  >
    Measure AI usage and monitor platform health
  </Card>
</CardGroup>