---
title: "Configuring Knowledges"
description: "Set up the Knowledges product for RAG (Retrieval-Augmented Generation) with model orchestration, rate limits, and vector stores."
---

<Frame>
  ![Knowledges Configuration](/images/ai-knowledge-nav.png)
</Frame>
