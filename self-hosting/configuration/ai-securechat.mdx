---
title: 'Creating a Chat Agent'
description: 'Learn how to configure and manage a Chat agent in Prisme.ai using Agent Creator, Knowledges or Builder.'
---

<Frame>
  <img src="/images/securechat.png" alt="Chat Agent Configuration" />
</Frame>

# Creating a Chat Agent

Chat is not a standalone product, but a **type of intelligent agent** that can be created and configured within Prisme.ai, using either **Agent Creator** or **Knowledges**, depending on the user's permissions and organizational context.
...
<Accordion title="Manual Creation via Agent Creator or Knowledges">
...
<Accordion title="Automated via Builder">
