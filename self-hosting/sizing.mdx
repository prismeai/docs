...
<Tabs>
  ...
  <Tab title="Vector Database">
    ...
    **Version:** Redis **6.2+** with `RedisJSON` and `RediSearch` modules (Redis Stack, ElastiCache + Redis Enterprise, Azure Cache for Redis Enterprise, or Memorystore Redis Cluster).
