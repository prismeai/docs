...
| WORKSPACE_OPS_MANAGER         | console, page        | Public base url towards Governe workspace webhooks for automatically deducing below  endpoints (customization, suggestions, products, ...). Example: `https://<API_URL>/v2/workspaces/{AIG_WORKSPACE_ID}/webhooks/`
