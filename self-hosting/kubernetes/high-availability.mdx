...
<Frame>
  <img src="/images/high-availability.png" alt="Prisme.ai High Availability Architecture" />
</Frame>
...
<CardGroup cols={2}>
  ...
  >
    Learn how to scale Prisme.ai efficiently
  </Card>
  <Card
  ...
  >
    Resolve availability issues quickly
  </Card>
  <Card
  ...
  >
    Configure and scale AI products
  </Card>
</CardGroup>