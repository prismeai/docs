...
- Move to a **ReadWriteMany** storage class (EFS / Azure Files / Filestore / CephFS) for workloads that can be re-scheduled freely; see [Requirements](/self-hosting/requirements#filesystems).
