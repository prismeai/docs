...
```bash
kubectl create secret generic core-secrets-encryption -n prismeai-core \
...
global:
  secretsEncryption:
    existingSecret: "core-secrets-encryption"   # pre-created above — chart skips generation entirely
```
