...
prismeai-runtime:
  storage:
    collections:
      driver: 'mongodb' # Collections db driver REQUIRED: mongodb, postgresql
...
global:
  ...
  storage:
    documents:
      ...
      user: ''
      password: ''
      existingSecret: 'apps-crawler-documents' # Auto generated secret: apps-crawler-documents
      secretKeys:
        url: '' 
        user: ''
        password: ''
    ...
    searchengines:
      ...
      existingSecret: 'apps-crawler-searchengines' # Auto generated secret: apps-crawler-searchengines
      secretKeys:
        url: ''
        password: ''  
```
