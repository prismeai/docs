...
- [Network Policies](/self-hosting/kubernetes/network-policies) — minimal service, database and external egress flows for default-deny clusters.
- [Resources & Autoscaling](/self-hosting/kubernetes/resources) — pick Balanced or High-throughput, HPA targets.
