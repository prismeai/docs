...
<CardGroup cols={2}>
  ...
  <Card title="Elasticsearch / OpenSearch" icon="magnifying-glass" href="/self-hosting/databases/elasticsearch#backup--restore">
...
- [Elasticsearch / OpenSearch](/self-hosting/databases/elasticsearch#backup--restore)
