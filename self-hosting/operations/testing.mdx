...
<Tip>
Most of the manual steps below are also covered by the open-source [automated end-to-end suite](/self-hosting/operations/e2e-testing), which drives a real browser against your instance. Use this page to check a deployment by hand; use the suite to re-check it on every upgrade, or in CI.
</Tip>
...
## Pages
1. Open Builder & create a workspace
...
1. Come back to Builder in order to create a new workspace
