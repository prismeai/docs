...
<Frame>
  <img src="/images/platform-scaling.png" alt="Prisme.ai Platform Scaling" />
</Frame>
...
<Tabs>
  <Tab title="Horizontal Scaling">
    <Frame>
      <img src="/images/horizontal-scaling.png" alt="Horizontal Scaling Approach" />
    </Frame>
  ...
  <Tab title="Vertical Scaling">
    <Frame>
      <img src="/images/vertical-scaling.png" alt="Vertical Scaling Approach" />
    </Frame>
  ...
  <Tab title="MongoDB">
    <Steps>
      ...
      <Step title="Configure Sharding">
        ...
        <Frame>
          <img src="/images/mongodb-sharding.png" alt="MongoDB Sharding" />
        </Frame>
  ...
  <Tab title="Elasticsearch/OpenSearch">
    <Steps>
      ...
      <Step title="Configure Node Roles">
        ...
        <Frame>
          <img src="/images/elasticsearch-roles.png" alt="Elasticsearch Node Roles" />
        </Frame>
...
<Steps>
  ...
  <Step title="Implement Regional Deployments">
    ...
    <Frame>
      <img src="/images/multi-region-architecture.png" alt="Multi-Region Architecture" />
    </Frame>
