...
Voici la version en anglais, technique et sans emoji, adaptée à des profils Ops/DevOps :

---

### Data Lifecycle Optimization and Index Cleanup in Elasticsearch/OpenSearch

To maintain high performance and reduce resource consumption at scale, it is critical to manage the data lifecycle effectively in your Elasticsearch or OpenSearch clusters.
