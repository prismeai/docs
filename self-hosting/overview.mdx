...
| **`prismeai-events`** | Real-time event bus over Redis Streams + persistence in Elasticsearch / OpenSearch. Powers the activity feed, analytics and audit. Hosts the cleanup CronJobs. |
...
| **`prismeai-crawler`** | Web and document crawler. Fetches, parses and indexes content into Elasticsearch / OpenSearch for RAG use cases. |
