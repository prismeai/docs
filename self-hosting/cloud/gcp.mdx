...
<Frame>
  <img src="/images/gcp-deployment.png" alt="Prisme.ai Deployment on Google Cloud Platform" />
</Frame>
...
<Accordion title="Database (MongoDB with Cloud SQL)">
...
<CardGroup cols={2}>
  ...
  >
    Configure Prisme.ai AI products effectively
  </Card>
  <Card
  ...
  >
    Learn how to manage backups and recovery
  </Card>
  <Card
  ...
  >
    Resolve common deployment issues efficiently
  </Card>
</CardGroup>