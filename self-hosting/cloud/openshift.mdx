...
<Frame>
  <img src="/images/openshift-deployment.png" alt="Prisme.ai Deployment on OpenShift" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="cogs"
    href="/self-hosting/configuration/ai-collection"
  >
    Configure AI products on your platform
  </Card>
  <Card
  ...
  >
    Manage and update your deployment effectively
  </Card>
  <Card
