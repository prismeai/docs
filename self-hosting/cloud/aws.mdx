...
| Redis | **ElastiCache for Redis** (cluster mode, Multi-AZ). For AI Knowledge, use **Redis Enterprise on ElastiCache** for `RedisJSON` + `RediSearch`. See [Redis](/self-hosting/databases/redis). |
