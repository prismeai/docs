...
Option B is the better choice for a shared cluster. It is also the one with more moving parts, so work through the checklist at the end of this section before concluding it does not work.
...
#### Option B: federated credentials, per ServiceAccount
...
Newer charts add two hooks that replace both the repetition above and the
