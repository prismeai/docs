...
| Redis | **Azure Cache for Redis — Enterprise tier** (RedisJSON + RediSearch available). See [Redis](/self-hosting/databases/redis). |
| Object storage | **Azure Blob Storage** + **Azure CDN / Front Door** for public assets. |
...
1. Open your Azure Managed Redis (or Cache for Redis Enterprise).
