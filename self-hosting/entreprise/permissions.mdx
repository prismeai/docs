...
<Tabs>
  <Tab title="Workspaces">
    <Frame>
      <img src="/images/workspace-concept.png" alt="Workspace Concept" />
    </Frame>
  ...
  <Tab title="Products">
    <Frame>
      <img src="/images/product-concept.png" alt="Product Concept" />
    </Frame>
...
<Frame>
  <img src="/images/sso-access.png" alt="SSO Access" />
</Frame>
...
<Frame>
  <img src="/images/product-roles.png" alt="Product Roles" />
</Frame>
...
Now that you understand Prisme.ai's permission management system, consider these next steps:

<CardGroup cols={2}>
  <Card title="Authentication Setup" icon="key" href="/resources/security/authentication">
    Configure authentication providers for your organization
  </Card>
  <Card title="Workspace Security" icon="shield" href="/resources/security/best-practices">
    Learn about advanced security features for workspaces
  </Card>
  <Card title="Audit Capabilities" icon="clipboard-list" href="/resources/security/audit">
    Discover how to track and audit user activities
  </Card>
  <Card title="AI Governance Configuration" icon="sliders" href="/products/ai-governance/overview">
    Set up comprehensive governance for your AI platform
  </Card>
</CardGroup>