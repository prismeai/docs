...
<Frame>
  <img src="/images/functions-microservice-overview.png" alt="Functions Microservice Architecture" />
</Frame>
...
<Accordion title="Dependency Management">
  ...
  - NodeJS functions can use NPM packages
  - Python functions can use PyPI packages
  - Dependencies are automatically installed when the function is created or updated
...
Now that you have the Functions Microservice up and running, here are some next steps to consider:

<CardGroup cols={2}>
  <Card title="Set Up Web Crawling" icon="spider-web" href="elf-hosting/entreprise/crawler-searchengine">
  ...
  <Card title="Configure LLM Access" icon="microchip-ai" href="self-hosting/entreprise/local-llm">
    ...
    <Card title="Build Workflow Automations" icon="diagram-project" href="/products/ai-builder/automations">
    Incorporate functions into complex workflow automations
  </Card>
    <Card title="Integrate with Agent" icon="robot" href="/products/ai-knowledge/tools-integration">
    Use functions as custom tools in your agents
  </Card>
