...
<Accordion title="Python Configuration">
  ...
  | `PYTHON_PACKAGES_WHITELIST_IMPORT` | Comma-separated list of allowed third-party packages for import.              | numpy, pandas, geopandas, tabulate, dateparser, urllib3, requests, pptx, docx                                     |
