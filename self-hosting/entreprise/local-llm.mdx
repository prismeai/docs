...
When using vLLM, you only need to add your endpoints in the Knowledges configuration.
Please refer to the Knowledges configuration documentation  for instructions on how to add these endpoints and the corresponding credentials.
...
## Integration with Knowledges

To use your local models with Prisme.ai's Knowledges:

<Steps>
  <Step title="Access Project Settings">
    Navigate to your Knowledges project and open the settings panel.
  </Step>
