...
<Frame>
  <img src="/images/apps-microservices-overview.png" alt="Apps Microservices Architecture" />
</Frame>
...
<Frame>
  <img src="/images/namespace-separation.png" alt="Namespace Separation Strategy" />
</Frame>
...
<Steps>
  <Step title="Retrieve the Helm Charts">
    ...
    **Option 1: Download the charts directly**
    ...
    ```
    https://helm.prisme.ai/charts/prismeai-apps/prismeai-apps-0.1.1.tgz
    ```
  ...
  <Step title="Configure Values File">
    ...
    <Frame>
      <img src="/images/values-configuration.png" alt="Values Configuration" />
    </Frame>
